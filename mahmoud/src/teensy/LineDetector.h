...
class LineDetector{
    ...
    private:
        ...
        float _lastLeftX = 0.0f;
        float _lastRightX = 0.0f;
        TrackInfo _trackInfo;
        SpeedControl _speedCtrl;
        ...
        void sortLeftVectors(LineVector arr[], int count);
        void sortRightVectors(LineVector arr[], int count);
